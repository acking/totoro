...
function Order(id, socket, data) {
    ...
    var orderUrlInfo = url.parse(data.runner)

    self.host = orderUrlInfo.host
    self.port = orderUrlInfo.port
    self.protocol = orderUrlInfo.protocol
    self.runner = orderUrlInfo.pathname
    self.charset = data.charset || 'utf8'
